    ...
    return (
        <div>
            <Card style={{ width: '18rem', backgroundColor: '#45ac8b', margin: 25 }}>
                <Card.Body>
                    <Card.Title  style={{ height: '30px', color: '#45ac8b', backgroundColor: '#fff' }}>{vendorDetails.doctorName}</Card.Title>
                    <Card.Text style={{ color: '#ad0000', fontWeight: "bold" }}>
                        Appointment Details
                    </Card.Text>
                    <Card.Footer style={{ color:'#fff' }}>  Appointment Date : {props.bookingData.appointmentDate} </Card.Footer>
                </Card.Body>
            </Card>
        </div>
    )
